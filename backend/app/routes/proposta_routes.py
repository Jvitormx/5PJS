...
from app.schemas.proposta_schema import CreateProposta, PropostaGet, PropostaGetAll, PropostaGetFornecedor
...
@router.post('/criar/{id_fornecedor}/{id_requisicao}', status_code=status.HTTP_201_CREATED, response_model=CreateProposta)
...
@router.get('/fornecedor/{id_fornecedor}', response_model=List[PropostaGetFornecedor])
